...
const Introduction: React.FC<IntroductionProps> = ({ onNavigate }) => {
  ...
  const coreModules = [
    ...
    },
    {
      ...
      title: "Golden System",
      tabId: "secret-room",
      desc: "Smart Income만의 독점 자동화 엔진. 가망고객 발굴부터 초기 상담까지 시스템이 스스로 작동합니다.",
        ...
        <div className="relative z-10 container mx-auto px-8 text-center max-w-5xl">
          ...
          >
            <div className="inline-flex items-center gap-3 px-6 py-2.5 rounded-full bg-white/5 border border-white/10 mb-12 backdrop-blur-md">
              ...
              <span className="text-[11px] font-black uppercase tracking-[0.2em] text-accent">AI Smart Income Revolution</span>
            </div>
            
            <h1 className="text-4xl lg:text-6xl font-black text-white mb-10 leading-[1.1] tracking-tight">
              노동이 아닌 <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-accent to-white">시스템으로</span> <br/>
              수익을 창출하세요.
            </h1>
            ...
            <p className="text-xl lg:text-2xl text-blue-100/70 font-medium mb-16 leading-relaxed max-w-3xl mx-auto">
              ...
              AI가 당신을 대신해 일하고, 당신은 그 가치를 누리는 <br/>
              <span className="text-white font-bold">차세대 수익 자동화 생태계</span>입니다.
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          <div className="space-y-10">
            ...
            <p className="text-lg text-gray-500 font-medium leading-relaxed">
              기존의 N잡은 결국 당신의 '시간'을 '돈'으로 바꾸는 노동이었습니다. <br/>
              Smart Income은 AI 기술을 통해 이 공식을 파괴합니다. <br/>
              우리는 파트너가 잠든 시간에도 작동하는 지능형 시스템을 제공합니다.
            </p>
